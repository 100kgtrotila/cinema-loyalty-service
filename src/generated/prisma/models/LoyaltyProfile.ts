...
// @ts-nocheck 
/*
 * This file exports the `LoyaltyProfile` model and its related types.
 *
...
export type LoyaltyProfileCountAggregateOutputType = {
  ...
  birthdayDate: number
  lastExpiryNotificationAt: number
...
export type GetLoyaltyProfileAggregateType<T extends LoyaltyProfileAggregateArgs> = {
      [P in keyof T & keyof AggregateLoyaltyProfile]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateLoyaltyProfile[P]>
    : Prisma.GetScalarType<T[P], AggregateLoyaltyProfile[P]>
}
...
export type GetLoyaltyProfileGroupByPayload<T extends LoyaltyProfileGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<LoyaltyProfileGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof LoyaltyProfileGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], LoyaltyProfileGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], LoyaltyProfileGroupByOutputType[P]>
      }
    >
  >
...
export type LoyaltyProfileWhereInput = {
  ...
  lastExpiryNotificationAt?: Prisma.DateTimeNullableFilter<"LoyaltyProfile"> | Date | string | null
...
export type LoyaltyProfileOrderByWithRelationInput = {
  ...
  lastExpiryNotificationAt?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type LoyaltyProfileScalarWhereWithAggregatesInput = {
  ...
  lastExpiryNotificationAt?: Prisma.DateTimeNullableWithAggregatesFilter<"LoyaltyProfile"> | Date | string | null
...
export type LoyaltyProfileCreateInput = {
  ...
  lastExpiryNotificationAt?: Date | string | null
  goldUpgradeUsedMonth?: string | null
...
export type LoyaltyProfileUpdateInput = {
  ...
  lastExpiryNotificationAt?: Prisma.NullableDateTimeFieldUpdateOperationsInput | Date | string | null
...
export type LoyaltyProfileCountOrderByAggregateInput = {
  ...
  lastExpiryNotificationAt?: Prisma.SortOrder
...
export type LoyaltyProfileSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  ...
  lastExpiryNotificationAt?: boolean
...
export type LoyaltyProfileCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<LoyaltyProfileFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface LoyaltyProfileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['LoyaltyProfile'], meta: { name: 'LoyaltyProfile' } }
  /**
   ...
   * })
  **/
  count<T extends LoyaltyProfileCountArgs>(
    args?: Prisma.Subset<T, LoyaltyProfileCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], LoyaltyProfileCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends LoyaltyProfileGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, LoyaltyProfileGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLoyaltyProfileGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface LoyaltyProfileFieldRefs {
  ...
  readonly lastExpiryNotificationAt: Prisma.FieldRef<"LoyaltyProfile", 'DateTime'>
